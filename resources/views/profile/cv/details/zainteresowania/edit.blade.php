...
<form enctype="multipart/form-data" action="{{ route('profile.cv.details.zainteresowania.update', [$zainteresowania->cv_id, $zainteresowania->id]) }}" method="post" accept-charset="utf-8">
                  @csrf
                  @method('PATCH')
