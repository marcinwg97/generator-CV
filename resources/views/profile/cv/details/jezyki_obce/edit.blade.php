...
<form enctype="multipart/form-data" action="{{ route('profile.cv.details.jezyki_obce.update', [$jezyki_obce_user->cv_id, $jezyki_obce_user->id]) }}" method="post" accept-charset="utf-8">
                  @csrf
                  @method('PATCH')
