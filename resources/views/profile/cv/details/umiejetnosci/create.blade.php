...
<form enctype="multipart/form-data" action="{{ route('profile.cv.details.umiejetnosci.index', $cevi->id) }}" method="post" accept-charset="utf-8">
                  @csrf
                            ...
                            <div class="form-group col-12">
                                <div class="d-flex justify-content-center">
                                    <button type="submit" class="btn btn-register">Zapisz</button>
                                </div>
                            </div>
                            </form>
