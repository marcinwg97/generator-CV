...
<form enctype="multipart/form-data" action="{{ route('profile.cv.details.umiejetnosci.update', [$umiejetnosci->cv_id, $umiejetnosci->id]) }}" method="post" accept-charset="utf-8">
                  @csrf
                  @method('PATCH')
                            ...
                            <div>
                                    <input id="description" type="text" class="form-control" name="description" value="{{$umiejetnosci->opis}}" required autofocus>
